...
"icon-camera_filled   ",
"icon-camera_line   ",
"icon-circle-diagonal_filled   ",
"icon-circle-diagonal_line   ",
"icon-circle-line_filled   ",
"icon-circle-line_line   ",
"icon-circle-wave_filled   ",
"icon-circle-wave_line   ",
"icon-close_filled   ",
"icon-close_line   ",
"icon-cloud_filled   ",
"icon-cloud_line   ",
...
"icon-conversation_line   ",
"icon-do-notdisturb   ",
"icon-documents   ",
"icon-download_fillled   ",
"icon-download_line   ",
"icon-export_filled   ",
"icon-export_line   ",
"icon-eye   ",
...
"icon-settings_line   ",
"icon-speaking_filled   ",
"icon-speaking_line   ",
"icon-speech-bubble_filled   ",
"icon-speech-bubble_line   ",
"icon-star_filled   ",
"icon-star_line   ",
"icon-time_filled   ",
"icon-time_line   ",
...
"icon-trash_filled   ",
"icon-trash_line   ",
"icon-video-recorder_filled   ",
"icon-video-recorder_line   ",
"icon-warning   ",
"icon-wifi   ",
"icon-wrench   ",
"icon-x   ",
...
classes.forEach(function(item){
  console.log('<div class="item-container" data-name="'+ item.substr(5) +'" onclick="this.childNodes[2].childNodes[0].select()"><h3>' + item + '</h3><p><i class="'+ item +'"></i></p><div><input type="text" onClick="this.select();" value="' + item + '" readonly/></div></div>')
})
